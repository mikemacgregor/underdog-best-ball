...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('data_dump', function (Blueprint $table) {
            ...
            // $table->enum('type', ['Fast Draft', 'Slow Draft']);
            // $table->string('tot_playoff_points_string');
            // $table->decimal('tot_playoff_points', 5, 2);
            // $table->unsignedTinyInteger('tourn_adv_round');
            // $table->timestamps();
        });
    }
